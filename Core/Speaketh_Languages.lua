...
Speaketh_Languages["Common"] = {
    ...
    -- Famous deterministic cross-faction output from WoW's language parser.
    fixed = { ["lol"] = "bur" },
    words = {
        [1]  = {"a","e","i","o","u","y"},
...
Speaketh_Languages["Darnassian"] = {
    blizzard = "Darnassian", race = {"Night Elf"}, faction = "Alliance",
    words = {
        [1]  = {"o","d","n","a","e","u","i"},
...
Speaketh_Languages["Seth'rak"] = {
    ...
    words = {
        [1]  = {"s","z","h","x","k","t"},
        [2]  = {"ss","hs","sk","zs","sh","ka","th","is","sa","zi","es","ka"},
        [3]  = {"sss","hss","ssk","ska","szh","seth","hiss","ssa","zsh","kah","tik","ssi","zul","sik"},
        [4]  = {"hiss","sska","seth","voll","sszt","tesh","raka","zsss","hssk","ssir","korr","vorr","ktha","ssal","zhak","tikh"},
        [5]  = {"hisss","sethr","sszka","voldu","korth","raksk","sslik","zheth","ssira","ktess","hasss","ssath","vsshk","zulra","tikha","ssveh"},
        [6]  = {"sethra","korthek","hisssk","vorrik","sslith","ssarva","zulahk","raksss","ktheth","ssliss","voldun","tesska","hasssk","zhakti","ssirak"},
        [7]  = {"sethral","korthak","atulman","mythrax","sslissa","ssarvak","zulahji","vsskoth","hisssik","raksseh","ktharra","ssvehli"},
        [8]  = {"sethrali","korthekt","atulaman","mythraxs","sslisska","zulahjin","vsskorth","hisssika","raksskah","ssvehlik","ktharrak","voldunar"},
        [9]  = {"sethralis","atulamans","zulahjins","mythraxss","korthekss","sslisskah","vsskorthe","raksskaht","ssvehlika","hisssikah"},
        [10] = {"sethraliss","atulamanss","zulahjinss","korthekssa","sslisskaht","vsskorthek","ssvehlikah","raksskahti"},
        [11] = {"sethralissa","atulamansse","korthekssat","sslisskahti","vsskorthekt","ssvehlikaht"},
        [12] = {"sethralissak","atulamanssek","korthekssath","vsskorthekta","sslisskahtir"},
    }
}

-- ============================================================
-- FURBOLG  (Ursine - primal, growling ursine tongue)
-- Furbolg has only two Blizzard-confirmed words: "vark" (justice) and
-- "ursa" (furbolg). Those are seeded into the appropriate buckets, and
-- the rest of the "glyph table" is built from canon furbolg name roots
-- (Timbermaw, Felpaw, Darkmaw, Swifttrack, Ragerun, Gripjaw) plus growl
-- aesthetics (grr, rawr, hurr, mrr).
--
-- NOTE: blizzard is intentionally nil. Furbolg IS a real in-game language,
-- but Speaketh never routes text through WoW's native language channel -
-- it sends romanized scramble as the visible message and the original over
-- a hidden addon channel, then the receiver's chat filter swaps in the
-- translation based on fluency. That handshake keys on the [Furbolg] tag,
-- so tying this to the native "Furbolg" slot would strip the tag for anyone
-- who has learned the real language and break translation for the fluent.
-- Keeping it a pure addon language means the chat body comes through
-- translated for those who understand it, and scrambled for those who don't
-- (the overhead speech bubble shows the scramble to everyone - no addon can
-- change another client's bubble font to the true glyphs).
-- ============================================================
Speaketh_Languages["Furbolg"] = {
    blizzard = nil, race = {"Furbolg"}, faction = nil,
    words = {
        [1]  = {"a","o","u","r","g","m"},
        [2]  = {"gr","rr","mr","ur","ka","da","mu","ro","ah","um","go","na"},
        [3]  = {"grr","rrr","urs","paw","maw","run","rae","hur","mur","gor","rok","dun","tim","fel","gnu"},
        [4]  = {"vark","ursa","grrr","hurr","rawr","maul","claw","fang","paws","mawr","runn","gnaw","daku","roka","akun","brrr"},
        [5]  = {"ursaa","varka","grrur","hurrm","mawla","rakun","gnarl","daroo","felku","akida","tundo","brumr","gorrn","mukaa"},
        [6]  = {"felpaw","darkmaw","gripjaw","ragerun","timbaw","ursaka","varkun","grroon","tundra","muraki","gnarok","brumak","akidaa","rokdun"},
        [7]  = {"timbaw","furbolg","darkmaw","swiftrk","gripjaw","ragerun","ursakan","varkoon","grrundo","murakii","gnaroka","brumakk"},
        [8]  = {"timbrmaw","furbolga","darkmawr","swifttrk","gripjawn","ragerunn","ursakann","grrundoo","murakiaa","gnarokan"},
        [9]  = {"timbermaw","furbolgan","swifttrak","gripjawun","ursakanna","grrundoon","murakiaar","gnarokana","brumakoon"},
        [10] = {"timbermawa","swifttrack","furbolgana","ursakannaa","grrundoona","murakiaarn","gnarokanaa"},
        [11] = {"timbermawan","swifttracka","furbolganaa","ursakannaar","grrundoonak","gnarokanaar"},
        [12] = {"timbermawana","swifttrackan","furbolganaar","ursakannaark","grrundoonaka"},
    }
}

-- ============================================================
-- TUSKARR  (Tuskarr - hearty walrus-folk of the frozen north)
-- Built from Tuskarr NPC/place-name roots (Kaskala, Moaki, Kamagua,
-- Elder Atuik, Kaw the Behemoth, Issliruk, Turrari) plus a rounded,
-- blubbery phonology.
-- ============================================================
Speaketh_Languages["Tuskarr"] = {
    blizzard = nil, race = {"Tuskarr"}, faction = nil,
    words = {
        [1]  = {"a","o","u","k","m","i"},
        [2]  = {"ka","mo","tu","ka","oa","ki","ru","na","um","ok","ai","wa"},
        [3]  = {"tus","kaw","moa","kal","rar","uik","nak","oki","ruk","kua","mag","aki","tur","iss"},
        [4]  = {"karr","moaki","kaws","atuik","turr","naku","kala","ruki","kama","issk","oaku","tusk","raro","kuaa","magu"},
        [5]  = {"tuska","moaki","kaska","kamag","atuik","issli","turra","nakua","ruksa","oakii","magua","kalaa","kawok"},
        [6]  = {"tuskar","kaskal","kamagu","isslir","turrar","atuika","nakuum","moakii","ruksah","magual","oakuun","kawoki"},
        [7]  = {"tuskarr","kaskala","kamagua","issliru","turrari","atuikaa","nakuuma","ruksaha","moakiin","magualo"},
        [8]  = {"kaskalaa","kamaguaa","issliruk","turrarii","atuikaan","nakuumaa","ruksahaa","moakiina","tuskarra"},
        [9]  = {"kaskalaan","kamaguaan","isslliruk","turrariin","atuikaana","nakuumaar","tuskarraa","moakiinaa"},
        [10] = {"kaskalaana","kamaguaana","issllirukk","turrariina","atuikaanaa","tuskarraan"},
        [11] = {"kaskalaanak","kamaguaanak","issllirukka","turrariinaa","tuskarraana"},
        [12] = {"kaskalaanaka","kamaguaanaka","turrariinaar","tuskarraanak"},
    }
}

-- ============================================================
-- MOGU  (Mogu - imperious, stone-hewn tongue of Pandaria)
-- Rooted in mogu lore (Lei Shen, Xin, Qiang, Meng, Zhan, Kua'fon,
-- Guo-Lai, Ai-Li) with a hard, clipped, tyrannical cadence.
-- ============================================================
Speaketh_Languages["Mogu"] = {
    blizzard = nil, race = {"Mogu"}, faction = nil,
    words = {
        [1]  = {"o","u","a","k","g","z"},
        [2]  = {"le","xi","qi","zh","ku","ka","go","me","ai","zha","ta","un"},
        [3]  = {"mog","lei","xin","meng","zho","kua","tao","zul","gur","kaz","han","qin","leo"},
        [4]  = {"mogu","shen","qiang","zhan","kuaf","guol","aili","meng","taon","zulk","gurr","kazh"},
        [5]  = {"leshen","qiang","kuafon","guolai","zandal","mengka","zhanto","taozin","gurthk","kazhan","xinmog"},
        [6]  = {"leishen","qianglo","kuafonn","guolaii","zandala","mengkaa","zhantoo","gurthok","kazhann","xinmogu","taozinn"},
        [7]  = {"leishenn","qianglok","kuafonna","guolaiin","zandalaa","mengkaar","zhantool","gurthokk","kazhanna","xinmoguu"},
        [8]  = {"leishenna","qiangloka","kuafonnaa","guolaiinn","zandalaar","mengkaarn","zhantooln","gurthokka"},
        [9]  = {"leishennaz","qianglokaa","kuafonnaar","guolaiinna","zandalaark","mengkaarno","zhantoolna"},
        [10] = {"leishennaza","qianglokaar","kuafonnaark","guolaiinnaz","zandalaarko","mengkaarnok"},
        [11] = {"leishennazak","qianglokaarn","kuafonnaarko","zandalaarkoz","guolaiinnaza"},
        [12] = {"leishennazaka","qianglokaarno","zandalaarkoza","kuafonnaarkoz"},
    }
}

-- ============================================================
-- OGRE  (Ogre - blunt, booming two-headed brute speech)
-- Gordunni / Gorian roots (Cho'gall, Gug, Mok, Ogri, Grull, Kron,
-- Dgan) with a lumbering, monosyllabic pound.
-- ============================================================
Speaketh_Languages["Ogre"] = {
    blizzard = nil, race = {"Ogre"}, faction = nil,
    words = {
        [1]  = {"g","o","u","k","m","r"},
        [2]  = {"go","mo","ug","ka","gu","ru","ok","um","ur","gr","mu","ba"},
        [3]  = {"gug","mok","ogr","gor","kro","dga","rul","bru","gna","dun","krg","mag","lok"},
        [4]  = {"ogri","gugg","mokk","gron","kron","grul","dgan","brut","magg","dunn","lokk","kraa","urgg","boul"},
        [5]  = {"ogrii","chogal","grull","gronn","kronn","dganny","brutt","maggr","gordun","lokkr","kraag","urggo"},
        [6]  = {"gordun","chogall","gronnk","kronnk","brutto","maggro","urggol","kraago","lokkru","dganny","ogrila"},
        [7]  = {"gordunn","chogall","gronnka","kronnko","bruttos","maggror","urggola","kraagor","gorians","dgannyk"},
        [8]  = {"gordunni","chogalla","gronnkaa","kronnkoz","bruttosk","maggroro","urggolaa","gorianss"},
        [9]  = {"gordunnia","chogallaa","gronnkaaz","kronnkozz","bruttoskk","maggrororo","gorianssk"},
        [10] = {"gordunniar","chogallaaz","gronnkaazz","kronnkozza","goriansskk"},
        [11] = {"gordunniark","chogallaazz","gronnkaazza","goriansskko"},
        [12] = {"gordunniarko","chogallaazza","goriansskkoz"},
    }
}

-- ============================================================
-- HOZEN  (Hozen - frantic, screeching monkey-folk chatter)
-- Deliberately manic and vowel-heavy (ook, eek, hoo, chka, gao) to
-- match hozen speech patterns from Pandaria.
-- ============================================================
Speaketh_Languages["Hozen"] = {
    blizzard = nil, race = {"Hozen"}, faction = nil,
    useRandom = true,
    words = {
        [1]  = {"o","e","a","u","i"},
        [2]  = {"ok","ee","oo","ah","ka","hu","gi","oi","uk","aa"},
        [3]  = {"ook","eek","hoo","gao","chk","hoz","kaa","waa","tik","noo","boo","haa","kik"},
        [4]  = {"ooka","eeka","hooo","chka","gaoo","hozn","waak","tika","kika","boop","haaz","noob"},
        [5]  = {"ookaa","eekaa","hoooo","chkaa","gaooo","hozen","waaka","tikaa","kikaa","boopa","haazu"},
        [6]  = {"ookaaz","eekaaz","chkaaa","gaoooo","hozenn","waakaa","tikaaz","kikaaz","boopaa","haazuu"},
        [7]  = {"ookaazu","eekaazu","chkaaaa","hozenna","waakaaz","tikaazu","kikaazu","boopaaa"},
        [8]  = {"ookaazuu","chkaaaaa","hozennaa","waakaazu","tikaazuu","boopaaaz"},
    }
}

-- ============================================================
-- MANTID  (Mantid - insectoid, chittering swarm-tongue)
-- Klaxxi / mantid roots (Kil'ruk, Xaril, Rik'kal, Ka'roz, Skeer,
-- Kaz'goroth) with clicks, apostrophes and buzzing sibilants.
-- ============================================================
Speaketh_Languages["Mantid"] = {
    blizzard = nil, race = {"Mantid"}, faction = nil,
    words = {
        [1]  = {"k","x","z","s","t","r"},
        [2]  = {"ka","ki","xa","ze","sk","ri","kl","zz","tk","ss","ax","ik"},
        [3]  = {"kil","xar","rik","kaz","zik","skk","kla","klx","zik","kra","tik","xil","zss"},
        [4]  = {"klax","kruk","xari","rikk","karo","zikk","skee","klxx","kazz","tikk","zssk","kraz"},
        [5]  = {"klaxx","kilruk","xaril","rikkal","karoz","zikka","skeer","klxxi","kazza","tikka","zsskk","krazg"},
        [6]  = {"klaxxi","kilruk","xarilk","rikkal","karozz","zikkal","skeerr","kazgor","tikkaz","krazgk","zsskri","xilkka"},
        [7]  = {"klaxxii","kilrukk","xarilka","rikkalk","karozza","zikkalk","skeerrk","kazgoro","tikkazk","krazgik"},
        [8]  = {"klaxxiik","kilrukka","xarilkaz","rikkalkk","karozzak","zikkalkr","kazgorot","skeerrki"},
        [9]  = {"klaxxiikk","kilrukkaz","xarilkazz","rikkalkkr","kazgoroth","zikkalkrr","skeerrkik"},
        [10] = {"klaxxiikkr","kilrukkazz","kazgorothk","rikkalkkrz","zikkalkrrk"},
        [11] = {"klaxxiikkrz","kazgorothkk","kilrukkazzk","rikkalkkrzk"},
        [12] = {"klaxxiikkrzk","kazgorothkkr","kilrukkazzkr"},
    }
}

-- ============================================================
-- KALIMAG  (Elemental - the primal tongue of the elements)
-- The shared root-language of Ignan, Aquan, Terran and Auran. Built
-- from elemental lore terms (Therazane, Ragnaros, Neptulon, Al'Akir,
-- Ossirian, Throne) with a resonant, echoing cadence.
-- ============================================================
Speaketh_Languages["Kalimag"] = {
    blizzard = nil, race = nil, faction = nil,
    words = {
        [1]  = {"a","o","u","r","k","n"},
        [2]  = {"ka","ra","ne","al","os","th","ur","gn","ro","ne","va","zu"},
        [3]  = {"kal","rag","nep","ala","oss","tha","ozz","gno","rok","zul","vor","kir","aki"},
        [4]  = {"kali","raga","nept","alak","ossi","thra","kirr","zulr","vorz","gnok","rokk","akir"},
        [5]  = {"kalim","ragna","neptu","alaki","ossir","theraz","kirra","zulra","vorzz","gnokk","rokka","akira"},
        [6]  = {"kalima","ragnar","neptul","alakir","ossiri","theraz","kirrag","zulraz","vorzza","gnokka","rokkan","akiraz"},
        [7]  = {"kalimag","ragnaro","neptulo","alakirr","ossiria","therazn","kirragg","zulrazz","vorzzan","gnokkan"},
        [8]  = {"kalimagg","ragnaros","neptulon","alakirrz","ossirian","therazan","kirraggn","zulrazza"},
        [9]  = {"kalimagga","ragnarosz","neptulonn","alakirrza","ossiriann","therazane","kirraggno"},
        [10] = {"kalimaggan","ragnaroszz","neptulonna","ossiriannk","therazanek","alakirrzan"},
        [11] = {"kalimaggana","neptulonnak","ossiriannko","therazaneka","ragnaroszza"},
        [12] = {"kalimagganaka","neptulonnaka","therazanekaz","ossiriannkoz"},
    }
}

-- ============================================================
-- RAVENSPEECH  (Arakkoa - lofty, cawing avian speech)
-- Rooted in Arakkoa/Apexis lore (Skyreach, Rukhmar, Terokk, Anzu,
-- Sethekk, Ishaal) with clipped caws and airy trailing vowels.
-- ============================================================
Speaketh_Languages["Ravenspeech"] = {
    blizzard = nil, race = {"Arakkoa"}, faction = nil,
    words = {
        [1]  = {"a","i","o","k","r","s"},
        [2]  = {"ka","ki","aw","ra","sk","ru","an","is","ok","es","ta","kr"},
        [3]  = {"ark","caw","sky","ruk","ter","anz","set","ish","kaa","rok","kra","kaw","tok"},
        [4]  = {"arak","caww","skyr","rukh","tero","anzu","seth","isha","kaaw","rokk","kraa","tokk"},
        [5]  = {"arakk","cawww","skyre","rukhm","terok","anzuu","sethe","ishaa","kaaww","rokka","kraaw","tokka"},
        [6]  = {"arakko","skyrea","rukhma","terokk","anzuur","sethek","ishaal","kaawwr","rokkaa","kraawn","tokkaa","cawwrk"},
        [7]  = {"arakkoa","skyreac","rukhmar","terokka","anzuurk","sethekk","ishaala","kaawwrk","rokkaar","kraawnk"},
        [8]  = {"arakkoan","skyreach","rukhmarr","terokkar","sethekkk","ishaalaa","kaawwrkk","rokkaarn"},
        [9]  = {"arakkoana","skyreachh","rukhmarra","terokkarr","sethekkkr","ishaalaan","kraawnkka"},
        [10] = {"arakkoanaa","skyreachhk","rukhmarraa","terokkarrn","sethekkkra","ishaalaana"},
        [11] = {"arakkoanaar","skyreachhkr","terokkarrna","rukhmarraan","sethekkkraa"},
        [12] = {"arakkoanaark","skyreachhkra","terokkarrnak","rukhmarraank"},
    }
}
